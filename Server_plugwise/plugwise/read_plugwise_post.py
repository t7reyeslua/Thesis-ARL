...
username = 'stretch'
password = 'ppwkcdzr'
url = 'http://akshaysn.ddns.net/minirest/appliances'

#Post to local database
urlphp = 'http://localhost/plugwise/plugwise2db.php'
...
def postToLocalDB(appliance):    
    ...
    #print r1 
    print appliance[1].get('name'), appliance[1].get('last_known_measurement'), appliance[1].get('current_power_usage')
