...
def send_mail():
    gmail_user = 'energydata.es@gmail.com'
    gmail_pwd = '@Kshay2014'
    FROM = 'energydata.es@gmail.com'
    TO = ['t7.reyeslua@gmail.com', 'akshay.uttama@gmail.com'] #must be a list
